...
\begin{figure}[H]
\begin{center}
  \makebox[\textwidth][c]{\includegraphics[keepaspectratio=true,scale=#1]{figures/#2}}
  \caption{#3}
  \label{#2}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
  \makebox[\textwidth][c]{\includegraphics[keepaspectratio=true,scale=#1]{figures/Placeholder}}
...
\begin{figure}[H]
 \centering 
  \makebox[\textwidth][c]{\fbox{\includegraphics[keepaspectratio=true,scale=#1]{figures/#2}}}
  \caption{#3}
  \label{#2}
\end{figure}
}
