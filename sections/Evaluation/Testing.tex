...
\fix{}{Note from Claus: Can we add a real world example, where we describe some
of the variables that would involve, could be in evaluation section.}
...
The \textc{Worker} class and tweet retrieval is discussed in
\autoref{workerLabel}.\nl
...
\fix{}{Remove pictures and add references to specific part in GUI chapter if
needed} 
...
%\figx[0.5]{testRequest}{Initial screen where the user inputs their Twitter
% name}
...
\figx{GUIresult2}{Column diagram showing the distribution of political leaning}
