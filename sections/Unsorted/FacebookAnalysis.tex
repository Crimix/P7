...
of data that the application wants to access \citep{FacebookGraphApiDocumentation}.\nl
...
pages on Facebook that they have marked as ``liked'' \citep{FacebookGraphApiDocumentation}.\nl
...
information can be gathered about the users on the chain \citep{FacebookGraphApiDocumentation}.\nl
