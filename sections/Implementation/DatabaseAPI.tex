...
\fix{}{This chapter was written while I was half blind, and very annoyed. As
such, it needs some more info in some parts (more tables, better description
of requests and responses). Also proof read (half-blind, remember?). Also, add
