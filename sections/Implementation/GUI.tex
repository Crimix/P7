...
opens. On this page, a bunch of graphs with different information can be found.
On \autoref{polSentiGraph}\fix{}{make the pic}, the graph depicts political
bias and the average 
