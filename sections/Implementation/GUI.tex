...
search bar is the search button and a help button. A visual presentation of the
front page can be seen on \autoref{GUIfrontPage}.
...
that the results are in and provides a link to the results. A visual
presentation of the E-mail can be seen on \autoref{GUImail}.

\figx[0.6]{GUImail}{The email received after the application is done
processing.}
...
\figx[0.4]{GUIresult1}{Graph showing the relation between media bias}

Apart from this, there are two bar charts showing the media bias of the
...
\figx[0.4]{GUIresult2}{The bar chart depicting media bias according to the Bag
of Words algorithm.}
