...
\fix{}{Insert some BS, err, introductory here about the chapter.}
...
called on the \ttt{Blueprint} instance \ttt{$table} are some of the abstractions
...
\ttt{created\_at} and \ttt{updated_at}. When these are present Laravel will
