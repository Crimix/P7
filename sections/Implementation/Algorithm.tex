...
\cited{sarlan2014twitter} where sentimental words a counted and used to
...
On \textc{lines 3-6} we start by iterating over a list containing subsets of the
total list of tweets, namely the  object \textc{``items''}. When doing this, we
create a new Task based on the \textc{AnalyzeAndDecorateTweets} method, and
