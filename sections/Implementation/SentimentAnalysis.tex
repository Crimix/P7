...
suporvised machine learning models, \say{\ldots the use of bigrams and trigrams
in your feature space may not necessarily yield any significant improvement.}
\citep{NGrams}.
