\section*{Initiating Problem} The implicit or explicit filtering of information
that users are subjected to, leads to a situation were users are not
exposed to differing news, opinions, and ideas. 

As such, this project will
focus on identifying and breaking a users filter bubble. 

Based on this
problem, the topic of this project, namely development of web applications,
services, and agents: we formulate the following initiating problem.
