\chapter{Requirements Analysis?}\label{cha:req}
...
\fix{}{Klaus: The web aspect seems to be missing? 
From the study regulations: A suitable user interface implies that it is
possible to interact with the developed solution using a web based interface.
...
have a web based
A further reuirement is that the implementation needs to have ascalaable
acrhitecture}
\fix{}{Make sure this fits with the new system}
