...
access \citep{FacebookGraphApiAccessTokens} \fix{}{Cant seem to find where this
strict thing is defined in the text so\ldots.}\Source .\nl
...
link in the ``share--chain'', \fix{but only limited information can be gathered
about the users on the chain \citep{FacebookGraphApiUserFeed}}{what limited
information?}\fix{}{Please explain to me, where you can see that about the
share--chain}.\nl
