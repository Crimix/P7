...
Facebook is a social media site with more than two billion users sharing
...
\begin{itemize}
  ...
  others that they like it.
  \item \textbf{Post:} A user can make a ``Post'' on a page which they have
  access to. A post can consist of text, media and similar elements.
  \item \textbf{Like:} A user can ``Like'' posts, comments and pages to show
  others their opinion of said element. When a user ``like'' a page, they will
  also be shown future posts by that page.
\end{itemize}


\subsubsection{Facebook API}
Facebook prohibits crawling of their website with a few exceptions such
